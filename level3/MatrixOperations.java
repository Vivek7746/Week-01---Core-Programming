...
public class MatrixOperations {
    ...
    public static int[][] createRandomMatrix(int rows, int cols) {
        ...
        // Fill the matrix with random values between 0 and 9
    ...
    // Method to display a double matrix (e.g., inverse matrix)
    ...
    public static void main(String[] args) {
        ...
        // Add matrices
        int[][] added = addMatrices(matrix1, matrix2);
        System.out.println("Added Matrices:");
        displayMatrix(added);

        // Subtract matrices
        int[][] subtracted = subtractMatrices(matrix1, matrix2);
        System.out.println("Subtracted Matrices:");
        displayMatrix(subtracted);
        ...
        // Find the inverse of matrix1 (2x2)
